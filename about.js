...
fetch('kids.json')
  ...
  .then(data => {
    ...
    data.cards.forEach(card => {
      ...
      <h3 style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif ; ">${card.name}</h3>
      <p style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;  ">${card.description}</p>
      <button  class="btn1" style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; border-radius:8px; background-color:black; color:white; padding: 5px 5px 5px 5px  ">${card.btn}</button>
